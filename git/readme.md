...
*   [Общее](https://github.com/stanislavfor/git-command/tree/master/git#Общее)
*   [Консольные команды](https://github.com/stanislavfor/git-command/tree/master/git#Консольные-команды)
*   [Примеры реальной работы](https://github.com/stanislavfor/git-command/tree/master/git#Примеры)
...
``` bash
git clone https://github.com:stanislavfor/git-command.git            # клонировать удаленный репозиторий в одноименную директорию
git clone https://github.com:stanislavfor/git-command.git FolderName # клонировать удаленный репозиторий в директорию «FolderName»
git clone https://github.com:stanislavfor/git-command.git .          # клонировать репозиторий в текущую директорию
```
...
git remote add origin https://github.com:stanislavfor/test.git # добавить удалённый репозиторий (с сокр. именем origin) с указанным URL
...
git remote add origin https://github.com:stanislavfor/test.git # добавляем предварительно созданный пустой удаленный репозиторий
